...
export function FormatSettingsPage({
  ...
  return (
    ...
    >
      <FormatSettingsContent language={language} />
    </DashboardLayout>
  );
}
...
function FormatSettingsContent({ language }: FormatSettingsContentProps) {
      ...
      <div className="mt-6 grid items-start gap-6 xl:grid-cols-[minmax(320px,0.54fr)_minmax(0,1fr)]">
        <aside>
          <FormatPanel
            ...
            settings={settings}
          />
          <div className="sticky bottom-0 mt-4 border-t border-white/[0.07] bg-[#0e0f12]/95 py-4 backdrop-blur-xl">
            <Button
